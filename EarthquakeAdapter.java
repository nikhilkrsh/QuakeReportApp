...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake>
{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView magTextView = (TextView)list_item_view.findViewById(R.id.textview1);


        String formattedMagnitude = formatMagnitude(quake.getMagnitude());
        ...
        String originalLocation= quake.getCountryplace();
        ...
        TextView primaryLocationView = (TextView) list_item_view.findViewById(R.id.primary_location);
        primaryLocationView.setText(primaryLocation);

        TextView locationOffsetView = (TextView) list_item_view.findViewById(R.id.location_offset);
        locationOffsetView.setText(locationOffset);
        Date dateObject = new Date(quake.getQuakedate());
